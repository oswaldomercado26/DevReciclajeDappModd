...
<div class="controls">
<input type="text" placeholder="Ingresar Nombre"  name="category" value="<?php echo  htmlentities($row['categoryName']);?>" class="span8 tip" required>
</div>
</div>
...
<div class="control-group">
											...
											<div class="controls">
												<textarea class="span8" name="Descripcion" rows="5"><?php echo  htmlentities($row['categoryDescription']);?></textarea>
											</div>
										</div>
									<?php } ?>	
