...
<?php } ?>
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="manage-products.php"><i class="menu-icon icon-table"></i>Resumen Productos </a></li>
                        
                            </ul><!--/.widget-nav-->

						<ul class="widget widget-menu unstyled">
							<li><a href="user-logs.php"><i class="menu-icon icon-tasks"></i> Login Log Usuarios </a></li>
