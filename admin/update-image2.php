...
<head>
	...
	<title>Admin| Actualizar Imagen</title>
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen del Producto Actual1</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Nueva Imagen del producto2</label>
<div class="controls">
