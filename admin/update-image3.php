...
<label class="control-label" for="basicinput">PNombre del Producto</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen del producto actual 1</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Nueva Imagen Producto 3</label>
<div class="controls">
