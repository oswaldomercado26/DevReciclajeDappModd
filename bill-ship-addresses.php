...
<div class="panel panel-default checkout-step-01">
	...
	<!-- panel-heading -->
    	...
    	<h4 class="unicase-checkout-title">
	        <a data-toggle="collapse" class="" data-parent="#accordion" href="#collapseOne" value="Blvd. Gral. Marcelino García Barragán 1421, Olímpica, 44430 Guadalajara, Jal." >
	          <span>1</span>Direccion de recoleccion
	        </a>
	     </h4>
    </div>
    <!-- panel-heading -->
...
<!-- checkout-step-01  -->
					    <!-- checkout-step-02  -->
					  	<div class="panel panel-default checkout-step-02">
						    <div class="panel-heading">
						      <h4 class="unicase-checkout-title">
						        <a value="Blvd. Gral. Marcelino García Barragán 1421, Olímpica, 44430 Guadalajara, Jal." data-toggle="collapse" class="collapsed" data-parent="#accordion" href="#collapseTwo">
						          <span>2</span>Dirección de recoleccion
						        </a>
						      </h4>
						    </div>
