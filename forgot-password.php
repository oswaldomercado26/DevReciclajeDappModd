...
$_SESSION['errmsg']="Cambio de contraseña exitoso";
exit();
}
else
{
...
$uri  = rtrim(dirname($_SERVER['PHP_SELF']),'/\\');
header("location:http://$host$uri/$extra");
$_SESSION['errmsg']="IEmail Incorrecto";
exit();
}
}
...
<html lang="en">
	<head>
	    ...
	    <title>Shopping Portal | Has olvidado tu contraseña</title>
...
?>
		...
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    <label class="info-title" for="exampleInputPassword1">Contacto <span>*</span></label>
...
<div class="form-group">
	    	<label class="info-title" for="confirmpassword">Confirmar Contrseña. <span>*</span></label>
