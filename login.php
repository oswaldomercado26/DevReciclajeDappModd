...
if($query)
{
	echo "<script>alert('Su registro es correcto');</script>";
}
else{
...
$uri  = rtrim(dirname($_SERVER['PHP_SELF']),'/\\');
header("location:http://$host$uri/$extra");
$_SESSION['errmsg']="Su Email o contraseña es incorrecto";
exit();
}
}
...
<html lang="en">
	<head>
	    ...
	    <title>Dev Reciclaje | Signi-in | Signup</title>
	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>Autentificacion</li>
			</ul>
...
<div class="col-md-6 col-sm-6 create-new-account">
	<h4 class="checkout-subtitle">Crear nueva contraseña</h4>
	<p class="text title-tag-line">Crea tu propia cuenta para adquirir productos.</p>
...
<div class="form-group">
	    	<label class="info-title" for="contactno">No. telefono <span>*</span></label>
...
<div class="form-group">
	...
	<div class="checkbox">
		  ...
		  Acelera tu camino a través de las aportaciones de reciclaje.
		</label>
		<label class="checkbox">
		Ver el estado de tus pedidos fácilmente.
		</label>
		<label class="checkbox">
