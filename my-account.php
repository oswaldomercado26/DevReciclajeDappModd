...
{
	echo "<script>alert('Su contraseña no es correcta !!');</script>";
}
}
...
{
alert("confirmar nueva contraseña esta vacia !!");
...
<div class="form-group">
            ...
            <div class="form-group">
					    <label class="info-title" for="name">Botes Reciclados<span></span></label>
					    <input type="text" class="form-control unicase-form-control text-input" value="<?php echo $row['Botes'];?>" id="name" name="name" readonly>
					  </div>
            <div class="form-group">
					    <label class="info-title" for="name">Dinero ganado<span>*</span></label>
					    <input type="text" class="form-control unicase-form-control text-input" value="<?php echo $row['Dinero'];?>" id="name" name="name" readonly >
					  </div>
			 ...
			 <input type="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" value="<?php echo $row['email'];?>" readonly>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Contact No.">Num Contacto <span>*</span></label>
