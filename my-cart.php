...
if(isset($_POST['submit'])){
		...
		foreach($_POST['quantity'] as $key => $val){
			...
			echo "<script>alert('Tu carro se ha actualizado');</script>";
		}
	}
...
// code for billing address updation
	if(isset($_POST['update']))
	{
		...
		if($query)
		{
echo "<script>alert('La dirección ha sido actualizada');</script>";
		}
	}
		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-sub-total item">Cargo</th>
...
$_SESSION['pid']=$pdtid;
	...
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">Direccion de recoleccion del producto</span>
				</th>
			</tr>
		</thead>
		<tbody>
...
?>
<div>
	<a>Nota: El unico dato editable es el PinCode </a>
</div>
<div class="form-group">
					    <label class="info-title" for="Billing Address">Direccion de recoleccion<span>*</span></label>
					    <textarea class="form-control unicase-form-control text-input"  name="billingaddress" required="required">Blvd. Gral. Marcelino García Barragán 1421 Modulo N taller Inventores</textarea>
					  </div>
			 ...
			 <input type="text" class="form-control unicase-form-control text-input" id="bilingstate" name="bilingstate" value="Guadalajara" required>
					  </div>
					  <div class="form-group">
					    <label class="info-title" for="Billing City">Ciudad <span>*</span></label>
					    <input type="text" class="form-control unicase-form-control text-input" id="billingcity" name="billingcity" required="required" value="Jalisco" >
					  </div>
 <div class="form-group">
...
<div class="col-md-4 col-sm-12 estimate-ship-tax">
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">Confirmar datos de envio</span>
				</th>
			</tr>
		</thead>
		<tbody>
...
<div class="form-group">
					    <label class="info-title" for="Shipping Address">Direccion de recoleccion<span>*</span></label>
					    <textarea class="form-control unicase-form-control text-input"  name="shippingaddress" required="required">Blvd. Gral. Marcelino García Barragán 1421 Modulo N taller Inventores</textarea>
					  </div>
			 ...
			 <input type="text" class="form-control unicase-form-control text-input" id="shippingstate" name="shippingstate" value="<?php echo $row['shippingState'];?>" required>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Billing City">Cuidad <span>*</span></label>
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary">Proceder a validar</button>
