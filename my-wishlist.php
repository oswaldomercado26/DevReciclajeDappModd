...
?>
						...
						<div class="rating">
							...
							<span class="review">( <?php echo htmlentities($num);?> Reseña )</span>
						</div>
						<?php } ?>
						<div class="price">$. 
				...
				<?php } } else{ ?>
				<tr>
					<td style="font-size: 18px; font-weight:bold ">Tus deseos estan vacios</td>
