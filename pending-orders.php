			...
			<thead>
				<tr>
					...
					<th class="cart-sub-total item">Precio</th>
						<th class="cart-sub-total item">Recargo</th>
					<th class="cart-total">total</th>
					<th class="cart-total item">Metodo Pago</th>
					<th class="cart-description item">Fecha Orden</th>
...
<tr>
	<td colspan="9"><div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary"><a href="payment-method.php">Procedes a pagar</a></button>
...
<?php } else {?>
<tr>
<td colspan="10" align="center"><h4>No se han encontrado resultados</h4></td>
</tr>
<?php } ?>
