...
echo "<script>alert('Producto añadido a mis deseos');</script>";
					...
					<div class="products">
						...
						<div class="cart clearfix animate-effect">
							...
							<button class="btn btn-primary" type="button">Añadir al carrito</button></a>
								<?php } else {?>
							<div class="action" style="color:green">En Stock</div>
					<?php } ?>
								...
								<div id="review" class="tab-pane">
									<div class="product-tab">
										...
										<div class="product-reviews">
											<h4 class="title">Valoración de los clientes</h4>
...
?>
										...
										<div class="product-add-review">
											<h4 class="title">Escribir tu reseña</h4>
			...
			<div class="product-price">	
				...
				<div class="action">
					<ul class="list-unstyled">
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rw['id']; ?>" class="lnk btn btn-primary">Añadir</a>
